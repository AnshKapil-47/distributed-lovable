...
public class StripePaymentProcessor implements PaymentProcessor {
    ...
    public CheckoutResponse createCheckoutSessionUrl(CheckoutRequest request) {
        ...
        try {
            ...
            if(stripeCustomerId == null || stripeCustomerId.isEmpty()){
                ...
                params.setCustomer(stripeCustomerId); // stripe customer id: user already has stripeId
            }
    ...
    public void handleWebhookEvent(String type, StripeObject stripeObject, Map<String, String> metadata) {
        ...
        log.debug("Handel stripe event: {}",type);
        ...
        switch (type){
            ...
            case "customer.subscription.completed" -> handleCustomerSubscriptionUpdated((Subscription) stripeObject); //when user cancel or upgrades or and updates
            case "customer.subscription.deleted" -> handleCustomerSubscriptionDeleted((Subscription) stripeObject); // when subs ends revoke access
